                  ...
                  <div class="card shadow-none border">
                     <div class="card-body">
                        <form class="row g-3" action="{{ route('aibot') }}" method="POST">
						   ...
						   <div id="hideandshow" class="col-12 border rounded pt-2" style="display: none;">
                              <label for="system_instructions" class="form-label">{{__('System instructions')}}</label>
                              <textarea type="text" id="system_instructions" name="system_instructions" class="form-control" id="keyword" cols="30" rows="4">{{ $device->system_instructions ?? '' }}</textarea>
                           </div>
                           <div id="hideandshow" class="col-12 border rounded pt-2" style="display: none;">
