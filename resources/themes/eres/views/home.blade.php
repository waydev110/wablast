						...
						<div class="card-body">
							<div class="d-flex align-items-center position-relative">
								...
								<div class="me-auto position-relative">
									...
									<p class="mb-0 mt-2 font-13">
										<span>{{ __('Remain: (:remain) Messages', [ 'remain' => $user->level === 'admin' ? '∞' : number_format($user->plan_data['messages_limit'] ?? 0) ]) }}</span>
									</p>
								</div>
							</div>
						</div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($numbers as $number)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    {{--<a href="{{ route('connect-via-code', $number->body) }}" class="badge badge-info shadow btn-xs sharp me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{__('Connect Via Code')}}"><i class="fa-solid fa-mobile-screen-button"></i></a>--}}
                                                    <a href="{{ route('scan', $number->body) }}" class="btn btn-primary shadow btn-xs sharp me-1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{__('connect Via QR')}}"><i class="fa-solid fa-qrcode"></i></a>
