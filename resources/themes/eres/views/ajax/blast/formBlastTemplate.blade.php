    ...
    <form class="flex flex-row" method="POST" enctype="multipart/form-data" id="formblast">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="col-md-7">
                ...
                <span class="text-danger">{{__('example Button link :')}} <span class="badge badge-secondary">{{__('url|YourText|YourLink')}}</span> <br> {{__('example Call button :')}} <span class="badge badge-secondary">{{__('call|YourText|Yournumber')}}</span>  <br> {{__('The type only have two options, call and url!')}}</span>
<br>
