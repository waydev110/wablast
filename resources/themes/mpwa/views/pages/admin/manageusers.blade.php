                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table-actions d-flex align-items-center gap-3 fs-6">
												<a href="{{ route('admin.loginAsUser', $user->id) }}" class="btn btn-warning btn-sm" 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="" method="POST" enctype="multipart/form-data" id="formUser">
                            ...
                            <input type="datetime-local" name="subscription_expired" id="subscription_expired" class="form-control" value="">
    ...
    function editUser(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
				...
				if(data.subscription_expired != null){
