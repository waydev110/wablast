<x-layout-dashboard title="{{__('Auto Replies')}}">
						...
						<tr>
							<td>
								<input data-url="{{ route('autoreply.update', $autoreply->id) }}"
									class="form-control keyword-update tags-input" data-id="{{ $autoreply->id }}"
    ...
    <div class="dropdown position-static">
        ...
        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton2">
            <li>
                <a onclick="viewReply({{ $autoreply->id }})" href="javascript:;" class="dropdown-item" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ __('Views') }}">
                    <i class="fa fa-eye me-2"></i> {{ __('Views') }}
                </a>
            </li>
            <li>
                <a href="{{ route('autoreply.edit', ['id' => $autoreply->id]) }}" class="dropdown-item" data-bs-toggle="tooltip" data-bs-placement="bottom" title="{{ __('Edit') }}">
                    <i class="fa fa-pencil me-2"></i> {{ __('Edit') }}
                </a>
            </li>
            <li>
				...
				<div class="modal-body">
					<form action="" method="POST" enctype="multipart/form-data" id="formautoreply">
						...
						<div class="mb-3">
							...
							<input type="text" name="keyword" class="form-control tags-input-add" id="keyword" required>
						</div>
						<div class="mb-3">
