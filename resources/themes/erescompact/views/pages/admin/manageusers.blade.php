                            ...
                            <tbody>
                                @foreach ($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex">
												<a href="{{ route('admin.loginAsUser', $user->id) }}" class="btn btn-warning shadow btn-xs sharp me-1" 
													style="width: auto;" onclick="return confirm('{{ __('Are you sure you want to login as this user?') }}')">
													{{ __('Login as User') }}
												</a>
