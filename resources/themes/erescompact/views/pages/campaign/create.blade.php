                            ...
                            <div class="tab-content col-md-10 offset-md-1 mt-4">
                                ...
                                <div id="step-2" class="tab-pane" role="tabpanel" aria-labelledby="step-2">
                                    ...
                                    <div class="mb-3 form-group">
										...
										<select class="default-select form-control wide phonebook-option" id="phonebook_id" name="phonebook_id">
                                    ...
                                    <div class="form-group">
										...
										<select class="default-select  form-control wide" id="type" name="type" required>
                                ...
                                <div id="step-3" class="tab-pane" role="tabpanel" aria-labelledby="step-3"
                                    ...
                                    <div class="form-group d-none" id="datetime">
										...
										<input type="datetime-local" id="datetime2" name="datetime" class="form-control"
											value="{{ old('datetime', \Carbon\Carbon::now()->setTimezone(auth()->user()->timezone ?? config('app.timezone'))->format('Y-m-d\TH:i')) }}">
									</div>
                                </div>
	...
	window.addEventListener('load', function() {
        $(document).ready(function() {
            ...
            function checkMultipleForm(type, count = 3, template = false) {
                ...
                let firstElement = '';
				if(type == 'sections'){
					firstElement = $(`input[name='${type}[0][title]']`).val();
				}else{
					firstElement = $(`input[name='${type}[1]']`).val();
				}
                ...
                if (step == 1) {
                    ...
                    if (type == 'text') {
                        ...
                        return requiredInput('message') && requiredInput('buttonlist') && requiredInput(
                            'namelist') && checkMultipleForm('sections', 5);
                    } else {
